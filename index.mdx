...
For `segmented_progress`, include `title`, `current_step`, `type`, and `number_of_steps`.
For `progress`, include `title`, `type: "progress"`, and either `percentage` or `value` plus `upper_limit`.

**Segmented Progress type**

<img className="image" src="https://cdn.activitysmith.com/features/start-live-activity.png" alt="Live Activity Start" />
...
<img
  ...
  alt="ProgressLive Activity Start"
/>
...
For segmented activities, send `current_step`. For progress activities, send `percentage` or `value` plus `upper_limit`.
...
<img
  ...
  alt="ProgressLive Activity Update"
/>
...
For segmented activities, keep sending `current_step`. For progress activities, send `percentage` or `value` plus `upper_limit`.

**Segmented Progress type**

<img className="image" src="https://cdn.activitysmith.com/features/end-live-activity.png" alt="Live Activity End" />
