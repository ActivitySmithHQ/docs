...
<CardGroup cols={2}>
  <Card title="Push Notifications" icon="bell" href="/api-reference/endpoint/push-notification" color="FF713C">
    Send a push notification to all of your paired devices.
  </Card>
  <Card title="Live Activities" icon="bolt" href="/api-reference/endpoint/live-activity-start" color="FF713C">
